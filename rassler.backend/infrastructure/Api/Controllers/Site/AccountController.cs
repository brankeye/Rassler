...
using rassler.backend.infrastructure.Api.Models;
using rassler.backend.infrastructure.Api.Providers;
using rassler.backend.infrastructure.Api.Results;
...
namespace rassler.backend.infrastructure.Api.Controllers.Site
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            ApplicationUser applicationUser = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
